...
<template>
    <div>
        ...
        <c-popup :isShow="isShow2" size="30" @afterClose="handleAfterClose2">
            <div class="content">
                <img src="../../../src/assets/hongbao2.png" :style="{ 'height': '500px' }" />
            </div>
        </c-popup>

        <c-popup :isShow="isShow3" size="40" @afterClose="handleAfterClose3">
            <div class="content">
                <img src="../../../src/assets/hongbao2.png" :style="{ 'height': '500px' }" />
            </div>
        </c-popup>

        <c-popup :isShow="isShow4" size="50" @afterClose="handleAfterClose4">
            <div class="content">
                <img src="../../../src/assets/hongbao2.png" :style="{ 'height': '500px' }" />
            </div>
        </c-popup>
